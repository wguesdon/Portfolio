#!/usr/bin/env python
"""Launch ensemble v13 on SageMaker (41 models: 32 previous + 7 new cuML + 2 new LGB)."""
import os
import shutil
...
estimator = PyTorch(
    ...
    output_path="s3://kaggle-ps6e4/output/ensemble-v13/",
    base_job_name="ps6e4-ensemble-v13",
