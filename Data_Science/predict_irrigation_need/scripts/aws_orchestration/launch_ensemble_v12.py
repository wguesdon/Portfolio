#!/usr/bin/env python
"""Launch ensemble v12 on SageMaker (32 models: 30 existing + lgb_ote_shallow + lgb_ote_deep)."""
import os
import shutil
...
# Copy both ensemble scripts to source dir
src_dir = "/tmp/sm_ensemble_v12"
...
estimator = PyTorch(
    ...
    output_path="s3://kaggle-ps6e4/output/ensemble-v12/",
    base_job_name="ps6e4-ensemble-v12",
