#!/usr/bin/env python
"""Launch ensemble v15 on SageMaker (43 models: v13's 41 + xgb_ote_shallow_gpu + lr_elastic)."""
import os
import shutil
...
estimator = PyTorch(
    ...
    output_path="s3://kaggle-ps6e4/output/ensemble-v15/",
    base_job_name="ps6e4-ensemble-v15",
