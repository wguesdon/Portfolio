#!/usr/bin/env python
"""Launch LGB pseudo-labeling SageMaker job."""
import os
import shutil
...
AWS_DIR = os.path.join(os.path.dirname(SCRIPTS_DIR), "aws")
...
src_dir = "/tmp/sm_pseudo"
if os.path.exists(src_dir):
    shutil.rmtree(src_dir)
os.makedirs(src_dir)
shutil.copy(os.path.join(AWS_DIR, "train_lgb_pseudo.py"), src_dir)

estimator = PyTorch(
    entry_point="train_lgb_pseudo.py",
    source_dir=src_dir,
    image_uri=AUTOGLUON_IMAGE,
    role=ROLE,
    instance_count=1,
    instance_type="ml.c5.9xlarge",
    output_path="s3://kaggle-ps6e4/output/lgb-pseudo/",
    base_job_name="ps6e4-lgb-pseudo",
